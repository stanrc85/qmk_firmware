...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[_QWERTY] = LAYOUT_split_bs_rshift(
		...
		KC_LCTL, KC_LGUI,                   KC_LALT, LT_SPCF, LT_SPCF,  TD_TWIN,                                     KC_MPLY, CA_SCLN, CA_QUOT
    ),
    [_DEFAULT] = LAYOUT_split_bs_rshift(
		KC_ESC,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS, KC_EQL,  KC_BSPC, KC_BSPC,
		KC_TAB,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_LBRC, KC_RBRC,          KC_BSLS,
		KC_CTLE, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT,                   KC_ENT,
		KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,          MO(_FN2_60),
		KC_LCTL, KC_LGUI,                   KC_LALT, KC_SPC,  KC_SPC,  TD_TWIN,                                     MO(_FN1_60), KC_RGUI, KC_RCTL
  ),
  	[_FN1_60] = LAYOUT_split_bs_rshift(
    	...
    	KC_CAPS, KC_HOME, KC_PGDN, KC_END,  _______, KC_VOLD, KC_VOLU, KC_LEFT, KC_DOWN, KC_RGHT, _______, _______,                   _______,
    	_______, _______, KC_RDP,  _______, _______, _______, _______, _______, _______, _______, _______, _______,          KC_PSCR, _______,
