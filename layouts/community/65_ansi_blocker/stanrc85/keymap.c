...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_QWERTY] = LAYOUT_65_ansi_blocker(
    ...
    KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT, KC_UP,            MO(_FN2_60),
    KC_LCTL, KC_LGUI, KC_LALT,                   LT_SPCF,          TD_TWIN, TD_TWIN,               KC_LEFT, KC_DOWN, KC_RGHT
  ),
  ...
  [_DEFAULT] = LAYOUT_65_ansi_blocker(
    ...
    KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT, KC_UP,            MO(_FN2_60),
    KC_LCTL, KC_LGUI, KC_LALT,                   KC_SPC,           MO(_FN1_60), MO(_FN1_60),           KC_LEFT, KC_DOWN, KC_RGHT
  ),
  ...
  [_FN2_60] = LAYOUT_65_ansi_blocker(
    ...
    _______, _______, _______,                            _______,                   TG(_DEFAULT), TG(_DEFAULT),     _______, _______, _______
  )
};
